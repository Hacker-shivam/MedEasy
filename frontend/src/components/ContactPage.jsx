  ...
  return (
    <div className={contactPageStyles.pageContainer}>
        ...
        <div className={contactPageStyles.gridContainer}>
                        ...
                        <div>
                         ...
                         <div>
                            ...
                            <input name='email' type='email' value={form.email} onChange={handleChange}
                             placeholder='eg@gmail.com' className={contactPageStyles.input} />
                                {errors.email && (
            ...
            {/* < className={contactPageStyles.formGrid}> */}
              <div>
                <label className={contactPageStyles.label}>
                  <Phone size={16} /> Phone
                </label>
              ...
              <div>
                ...
                <div>
                    ...
                    <textarea name='message' value={form.message}
                     onChange={handleChange} placeholder='Describe your concern...'
                ...
                <div>
                    <button className={contactPageStyles.buttonContainer}>
                        <button type='submit' className={contactPageStyles.button}>
                            <SendHorizonal size={20} /> <span>Send via Whatsapp</span>
                        </button>
            ...
            <div className={contactPageStyles.infoContainer}>
                <div className={contactPageStyles.infoCard}>
                    ...
                    <p className={contactPageStyles.infoText}>
                        Chhatarpur, New Delhi, India
                    </p>
                    <p className={contactPageStyles.infoItem}>
                        <Phone size={16} />0000000000
                    </p>
                    <p className={contactPageStyles.infoItem}>
                ...
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d56103.309000731024!2d77.144699682858!3d28.495900789065455!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d1e41ca7de7c1%3A0x921a88ef7354b930!2sChhatarpur%2C%20New%20Delhi%2C%20Delhi!5e0!3m2!1sen!2sin!4v1770787333979!5m2!1sen!2sin"
