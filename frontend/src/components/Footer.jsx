...
import {Stethoscope, Activity, Icon, Send, Facebook, Twitter, Instagram, Linkedin, Youtube, ArrowRight, MapPin, Phone, Mail } from 'lucide-react'
            ...
            <div className={footerStyles.gridContainer}>
                <div className={footerStyles.companySection}>
                    <div className={footerStyles.logoContainer}>
                        ...
                        <div >
                            <h2 className={footerStyles.companyName}>MedEasy</h2>
                    ...
                    <p className={footerStyles.companyDescription}>
                        ...
                        We're commited to providing exceptional medical care
                    ...
                    <div className={footerStyles.contactContainer}>
                        <div className={footerStyles.contactItem}>
                            ...
                            <span className={footerStyles.contactText}>+91 7859642585</span>
                        </div>
                        ...
                        <div className={footerStyles.contactItem}>
                            ...
                            <span className={footerStyles.contactText}>medeasy@gmail.com</span>
                        </div>
                        ...
                        <div className={footerStyles.contactItem}>
                            ...
                            <span className={footerStyles.contactText}>New Delhi, India</span>
                        </div>
                    </div>
                </div>
          ...
          <Icon className={`${footerStyles.socialIcon} ${color}`} />
            ...
            <div className={footerStyles.bottomSection}>
                <div className={footerStyles.copyright}>
                    <span>&copy; 2026 MedEasy</span>
                </div>

                <div className={footerStyles.designerText}>
                    <span>Designed By</span>
                    <a href='' target='_blank' className={footerStyles.designerLink}>Shivam Rajput</a>
                </div>
            </div>
        </div>
