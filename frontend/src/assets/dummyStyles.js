...
export const bannerStyles = {
  ...
  bookButton: "group relative lg:whitespace-nowrap bg-gradient-to-r from-green-500 to-emerald-300 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-full font-semibold transform transition-all duration-300 shadow-2xl hover:shadow-3xl overflow-hidden text-sm sm:text-base",
...
export const doctorsPageStyles = {
  ...
  headerTitle: "text-3xl sm:text-4xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-emerald-700 to-teal-600 bg-clip-text text-transparent mb-3 tracking-tight",
  ...
  bookButton: "w-full inline-flex items-center justify-center gap-2 py-2 rounded-full font-medium transition-all duration-300 text-sm bg-gradient-to-r from-emerald-300 to-teal-500 text-white hover:shadow-lg",
...
export const loginPageStyles = {
  ...
  // Submit button
  submitButton: "w-full py-3 bg-gradient-to-r from-emerald-400 to-green-600 text-white font-semibold rounded-full",
...
export const navbarStyles = {
  ...
  loginButton: "btn-login hidden lg:flex lg:text-sm items-center gap-2 bg-gradient-to-r from-emerald-400 to-green-600  text-white px-6 py-2.5 rounded-full font-semibold hover:shadow-xl transition-all duration-300 cursor-default",
  loginIcon: "w-4 h-4",
...
// Mobile menu
mobileMenu:
  "mobile-menu lg:hidden block rounded-xl p-4 space-y-2 border-t border-emerald-100 pt-4",
mobileMenuItem:
...
mobileDoctorAdminButton:
  "w-full flex items-center justify-center gap-2 py-2.5 rounded-full border border-emerald-200 bg-white text-sm font-semibold hover:bg-emerald-50 transition-all cursor-pointer",

mobileLoginContainer:
  "w-full mt-3",

mobileLoginButton:
  "w-full flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-500 to-green-600 text-white py-2.5 rounded-full font-semibold hover:shadow-lg transition-all cursor-pointer",
...
export const listPageStyles = {
  // Main container
  pageContainer: "min-h-screen pt-20 md:pt-25 lg:pt-24 font-serif p-4 sm:p-6 bg-gradient-to-br from-emerald-50 to-white",
...
export const editProfilePageStyles = {
  ...
  toastSuccess: "bg-gradient-to-r from-emerald-50 to-emerald-100 border-l-4 border-emerald-500",
  toastError: "bg-gradient-to-r from-rose-50 to-rose-100 border-l-4 border-rose-500",
  toastInfo: "bg-gradient-to-r from-blue-50 to-blue-100 border-l-4 border-blue-500",
  ...
  headerBackground: "relative h-24 sm:h-28 md:h-32 bg-gradient-to-r from-emerald-400 to-emerald-600",
  ...
  profileName: "text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-emerald-700 to-emerald-900 bg-clip-text text-transparent truncate",
  ...
  editButton: "group relative overflow-hidden bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 text-white px-5 py-2 rounded-full cursor-pointer shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-[1.02] w-full sm:w-auto",
  ...
  addDateButton: "flex items-center gap-2 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white px-4 py-2 rounded-xl shadow-md hover:shadow-lg transition-all duration-200 text-sm sm:text-base",
  addDateIcon: "w-4 h-4",
