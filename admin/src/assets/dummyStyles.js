...
export const doctorDetailStyles = {
  // Layout styles
  pageContainer: "min-h- font-serif bg-gradient-to-br from-emerald-50 via-white to-green-50 p-4 sm:p-6",
  ...
  // File upload styles
  fileInput: "w-40 md:w-[180px] border-2 border-emerald-300 rounded-full p-2 text-sm bg-white focus:border-emerald-400 transition",
  ...
  submitButtonEnabled: "bg-gradient-to-r from-emerald-500 to-cyan-500 text-white",
...
export const addServiceStyles = {
  ...
  // Header styles
  header: {
    title: "text-2xl sm:text-3xl font-extrabold text-transparent bg-gradient-to-r from-emerald-700 to-teal-600 bg-clip-text",
  ...
  buttons: {
    ...
    submit: "inline-flex justify-center items-center gap-2 w-full sm:w-auto px-5 py-2 rounded-full bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-medium hover:shadow-lg transition-all duration-200 disabled:opacity-60",
    ...
    addSlot: "w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-full bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-medium hover:shadow-lg transition-all duration-200",
    ...
    container: (hasError) => 
      `w-full rounded-2xl p-4 ${
        hasError 
          ...
          : "bg-gradient-to-b from-emerald-50 to-teal-50 border border-emerald-100"
  ...
  slots: {
    container: (hasError) => 
      `bg-gradient-to-br from-white to-emerald-50 rounded-2xl p-4 ${
        hasError 
          ? "border-2 border-red-200" 
          : "border border-emerald-50"
      } shadow-sm`,
    slotItem: "flex items-center gap-2 bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-100 px-2 py-2 my-1 rounded-full shadow hover:shadow-md transition-shadow min-w-0",
  ...
  toast: {
    ...
    toastSuccess: "bg-gradient-to-r from-emerald-50 to-teal-50 border-emerald-100",
    iconContainer: (type) => {
      const styles = {
        ...
        success: "bg-gradient-to-r from-emerald-100 to-teal-100 text-emerald-600"
      };
...
export const navbarStyles = {
  ...
  logoImage: "w-20 h-20 rounded-full",
...
export const serviceDashboardStyles = {
  // Container styles
  container: "min-h-screen font-serif p-4 sm:p-6 bg-gradient-to-b from-emerald-100 via-emerald-50 to-white",
  ...
  statCard: {
    container: "rounded-full bg-gradient-to-br from-emerald-100 to-emerald-50 shadow-sm border border-green-100 p-4 gap-4 flex items-center",
