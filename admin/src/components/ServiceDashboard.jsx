      ...
      <div className={serviceDashboardStyles.innerContainer}>
        ...
        <div className={serviceDashboardStyles.header.container}>
            ...
            <div className={serviceDashboardStyles.statGrid}>
                <StatCard icon={<ClipboardList size={20} />}
                 label="Total Services"
                 value={totals.totalServices} 
                 />
                
                <StatCard icon={<Calendar size={20} />}
                 label="Total Appointments"
                 value={totals.totalAppointments} 
                 />

                <StatCard icon={<BadgeIndianRupee size={20} />}
                ...
                {loading ? (
                  ...
                  visibleServices.map((s) => {
                    ...
                    <div className={serviceDashboardStyles.table.desktopView}>
                      <div className=' col-spa-5 flex items-center gap-4'>
                      ...
                      <div className={serviceDashboardStyles.table.desktopCell(2)}>{formatCurrency(s.price)}</div>
                      <div className={serviceDashboardStyles.table.desktopCenterCell(1)}>{s.totalAppointments}</div>
                      <div className={serviceDashboardStyles.table.desktopCenterCell(1)}>{s.completed}</div>
                      <div className={serviceDashboardStyles.table.desktopCenterCell(1)}>{s.canceled}</div>
                      <div className={`${serviceDashboardStyles.table.desktopCell(2)} text-right `}>{formatCurrency(earnings)}</div>
                    </div>
