...
import { BadgeIndianRupee, CalendarRange, CheckCircle, Search, User, UserRoundCheck, Users, XCircle } from 'lucide-react';
    ...
    <div className={s.pageContainer}>
      <div className={s.maxWidthContainer}>
        ...
        <div className={s.statsGrid}>
          ...
          label="Total Register user" value={patientCountLoading ? "Loading....." : (patientCount ?? totals.totalLoginPatients)} />
  ...
  return (
    <div className={s.mobileDoctorCard}>
      ...
      <div className={s.mobileEarningsContainer}>
        <div>Earned</div>
        <div>₹ {d.earnings.toLocaleString()}</div>
      </div>
    </div>
  )
}
