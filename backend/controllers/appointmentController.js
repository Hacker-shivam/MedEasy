...
export const getAppointments = async (req, res) => {
  try {
    ...
    return res.json({
      success: true,
      appointments: items, // ✅ frontend-compatible
      meta: {
        page,
        limit,
        total,
...
export const createAppointment = async (req, res) => {
    ...
    //  Duplicate booking preservation
    ...
    if(existingBooking) {
        return res.status(409).json({
            success: false,
            message: "You already have an appointment with this doctor at selected slot."
        })
    }
...
export const confirmPayment = async (req, res) => {
    try {
        ...
        try {
            ...
            console.error("Stripe retrive session");
